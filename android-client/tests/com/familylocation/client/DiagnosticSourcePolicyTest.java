...
public final class DiagnosticSourcePolicyTest {
    ...
    public static void main(String[] args) {
        ...
        assertNotEquals(
            sourceKey("gps", "", "amap", "amap", 0),
            sourceKey("gps", "", "meituan", "meituan", 1),
            "independent reverse-geocoding providers stay distinct"
        );
        assertTrue(
        ...
        String evidence = DiagnosticSourcePolicy.evidenceKey(
            "203.0.113.8", "amap", "server-a", "precise address", "30.1,120.2"
        );
        assertEquals(
            evidence,
        ...
        assertNotEquals(
            evidence,
            DiagnosticSourcePolicy.evidenceKey(
                "203.0.113.8", "meituan", "server-b", "precise address", "30.1,120.2"
            ),
