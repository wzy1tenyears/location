...
func NewRouter(cfg config.Config, db *sql.DB) http.Handler {
	...
	adminHeartbeat := handlers.NewAdminHeartbeatHandler(sessions)
	...
	mux.Handle("POST /api/admin/heartbeat", middleware.Chain(http.HandlerFunc(adminHeartbeat.Touch), appOnly))
