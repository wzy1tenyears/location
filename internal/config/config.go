...
func Load() Config {
	return Config{
		...
		App: AppConfig{
			...
			VersionCode:       envInt("LOC_ANDROID_VERSION_CODE", 150),
			VersionName:       env("LOC_ANDROID_VERSION_NAME", "2.3.6"),
		...
		Admin: AdminConfig{
			VersionCode: envInt("LOC_ANDROID_ADMIN_VERSION_CODE", 100),
			VersionName: env("LOC_ANDROID_ADMIN_VERSION_NAME", "2.3.5"),
