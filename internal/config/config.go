...
func Load() Config {
	return Config{
		...
		App: AppConfig{
			...
			VersionCode:       envInt("LOC_ANDROID_VERSION_CODE", 149),
			VersionName:       env("LOC_ANDROID_VERSION_NAME", "2.3.5"),
		...
		Admin: AdminConfig{
			VersionCode: envInt("LOC_ANDROID_ADMIN_VERSION_CODE", 99),
			VersionName: env("LOC_ANDROID_ADMIN_VERSION_NAME", "2.3.4"),
