...
func Load() Config {
	return Config{
		...
		App: AppConfig{
			...
			VersionCode:       envInt("LOC_ANDROID_VERSION_CODE", 156),
			VersionName:       env("LOC_ANDROID_VERSION_NAME", "2.3.12"),
		...
		Admin: AdminConfig{
			VersionCode: envInt("LOC_ANDROID_ADMIN_VERSION_CODE", 102),
			VersionName: env("LOC_ANDROID_ADMIN_VERSION_NAME", "2.3.7"),
