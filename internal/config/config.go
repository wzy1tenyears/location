...
func Load() Config {
	return Config{
		...
		App: AppConfig{
			...
			VersionCode:       envInt("LOC_ANDROID_VERSION_CODE", 159),
			VersionName:       env("LOC_ANDROID_VERSION_NAME", "2.3.15"),
		...
		Admin: AdminConfig{
			VersionCode: envInt("LOC_ANDROID_ADMIN_VERSION_CODE", 103),
			VersionName: env("LOC_ANDROID_ADMIN_VERSION_NAME", "2.3.8"),
