...
func TestLoadUsesConservativeProviderQuotaDefaults(t *testing.T) {
	for _, key := range []string{
		...
		"LOC_IP_API_QUOTA_MAX_REQUESTS", "LOC_IP_API_QUOTA_RESERVE_REQUESTS", "LOC_IP_API_QUOTA_USER_MAX_MISSES", "LOC_IP_API_QUOTA_WINDOW_SECONDS",
		"LOC_UAPIS_QUOTA_MAX_REQUESTS", "LOC_UAPIS_QUOTA_RESERVE_REQUESTS", "LOC_UAPIS_QUOTA_USER_MAX_MISSES", "LOC_UAPIS_QUOTA_WINDOW_SECONDS",
		"LOC_BAIDU_IP_QUOTA_MAX_REQUESTS", "LOC_BAIDU_IP_QUOTA_RESERVE_REQUESTS", "LOC_BAIDU_IP_QUOTA_USER_MAX_MISSES", "LOC_BAIDU_IP_QUOTA_WINDOW_SECONDS",
		"LOC_IPING_QUOTA_MAX_REQUESTS", "LOC_IPING_QUOTA_RESERVE_REQUESTS", "LOC_IPING_QUOTA_USER_MAX_MISSES", "LOC_IPING_QUOTA_WINDOW_SECONDS",
		"LOC_XXAPI_QUOTA_MAX_REQUESTS", "LOC_XXAPI_QUOTA_RESERVE_REQUESTS", "LOC_XXAPI_QUOTA_USER_MAX_MISSES", "LOC_XXAPI_QUOTA_WINDOW_SECONDS",
	} {
		t.Setenv(key, "")
	}
